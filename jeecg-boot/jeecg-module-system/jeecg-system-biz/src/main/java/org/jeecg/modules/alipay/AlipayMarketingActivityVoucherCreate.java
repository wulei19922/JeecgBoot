...
public class AlipayMarketingActivityVoucherCreate {

    public static void main(String[] args) throws AlipayApiException, ParseException {
        mianchongzhi(args);
    }

    public static void mianchongzhi(String[] args) throws AlipayApiException, ParseException {
        // 初始化SDK
        ...
        // 设置外部业务单号
        model.setOutBizNo("asdh12394nb23941234xasd2021");
    ...
    public static void yuchongzhi(String[] args) throws AlipayApiException, ParseException {
        // 初始化SDK
        AlipayClient alipayClient = new DefaultAlipayClient(getAlipayConfig());
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        sdf.setTimeZone(TimeZone.getTimeZone("GMT+8"));
        ...
        voucherSendModeInfo.setVoucherSendMode("DIRECT_SEND_MODE");
        VoucherSendRuleInfo voucherSendRuleInfo = new VoucherSendRuleInfo();
        voucherSendRuleInfo.setQuantity(1L);
        voucherSendRuleInfo.setPublishStartTime(sdf.parse("2025-03-24 00:00:01"));
        voucherSendRuleInfo.setPublishEndTime(sdf.parse("2025-03-26 23:59:59"));
        voucherSendModeInfo.setVoucherSendRuleInfo(voucherSendRuleInfo);
        model.setVoucherSendModeInfo(voucherSendModeInfo);
        ...
        VoucherAvailableAccountInfo voucherAvailableAccountInfo = new VoucherAvailableAccountInfo();
        List<String> availablePids = new ArrayList<String>();
        availablePids.add("2021005129683168");
        voucherAvailableAccountInfo.setAvailablePids(availablePids);
        voucherAvailableScopeInfo.setVoucherAvailableAccountInfo(voucherAvailableAccountInfo);
        model.setVoucherAvailableScopeInfo(voucherAvailableScopeInfo);
        ...
        // 设置资金信息
        VoucherBudgetSupplyInfo voucherBudgetSupplyInfo = new VoucherBudgetSupplyInfo();
        voucherBudgetSupplyInfo.setBudgetType("RECHARGE");
        ...
        voucherBalanceRechargeInfo.setAmount("50.00");
        voucherBalanceRechargeInfo.setPartnerId("2088512417841101");
