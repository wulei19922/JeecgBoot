...
enum Api {
  list = '/m/marketVouchers/list',
  save = '/m/marketVouchers/add',
  edit = '/m/marketVouchers/edit',
  deleteOne = '/m/marketVouchers/delete',
 ...
 * @param params
 */
export const marketVouchersMerchantsList = Api.marketVouchersMerchantsList;
/**
 * 列表接口
 * @param params
 */
